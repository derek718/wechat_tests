...
class mysql():
    ...
    def __init__(self, table='', prefix=''):
        ...
        """
        self.host = '118.178.91.98'
        self.user = 'root'
        self.passwd = 'ai~!@dsi$@ds'
        self.db = 'guoke'
        self.charset = 'utf8'
        self.prefix = 'gk_'
    ...
    def __conn(self):
        ...
        self.conn = pymysql.connect(host=self.host, user=self.user, passwd=self.passwd, db=self.db,
                                    charset=self.charset, cursorclass=pymysql.cursors.DictCursor,connect_timeout=10)
